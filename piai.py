...
def wait_for_result():
    sleep(1)
    xpath_input = '/html/body/div/main/div/div/div[3]/div[1]/div[4]/div/div[2]/textarea'
    driver.find_element(by=By.XPATH, value=xpath_input).send_keys("Testing...")
    sleep(1)
    while True:
        ...
        try:
            if False==Button:
                ...
                driver.find_element(by=By.XPATH, value=xpath_input).clear()
                break
        except:
            pass
